...
describe Krash::Notifiers::Codebase::Base do
  ...
  before do
    ...
    @notifier = Krash::Notifiers::Codebase::Base.new(@default_config)
  end
  ...
  describe "Notification" do
    it "should create a ticket" do
      ...
      Krash::Notifiers::Codebase::CodebaseProject.should_receive(:new).with(hash_including(
